...
export const getAnalyzeCareerDecisionUrl = () => {




  return `/api/decision-engine/analyze`
}

/**
 * @summary Analyze career profile with Claude AI (SSE stream)
 */
export const analyzeCareerDecision = async (decisionEngineRequest: DecisionEngineRequest, options?: RequestInit): Promise<unknown> => {

  return customFetch<unknown>(getAnalyzeCareerDecisionUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(decisionEngineRequest)
  }
);}
...
export const getAnalyzeCareerDecisionMutationOptions = <TError = ErrorType<AnthropicError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof analyzeCareerDecision>>, TError,{data: BodyType<DecisionEngineRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof analyzeCareerDecision>>, TError,{data: BodyType<DecisionEngineRequest>}, TContext> => {

const mutationKey = ['analyzeCareerDecision'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof analyzeCareerDecision>>, {data: BodyType<DecisionEngineRequest>}> = (props) => {
          const {data} = props ?? {};

          return  analyzeCareerDecision(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AnalyzeCareerDecisionMutationResult = NonNullable<Awaited<ReturnType<typeof analyzeCareerDecision>>>
    export type AnalyzeCareerDecisionMutationBody = BodyType<DecisionEngineRequest>
    export type AnalyzeCareerDecisionMutationError = ErrorType<AnthropicError>

    /**
 * @summary Analyze career profile with Claude AI (SSE stream)
 */
export const useAnalyzeCareerDecision = <TError = ErrorType<AnthropicError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof analyzeCareerDecision>>, TError,{data: BodyType<DecisionEngineRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof analyzeCareerDecision>>,
        TError,
        {data: BodyType<DecisionEngineRequest>},
        TContext
      > => {
      return useMutation(getAnalyzeCareerDecisionMutationOptions(options));
    }
