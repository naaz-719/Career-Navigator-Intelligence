 ...
 */
export const AnalyzeCareerDecisionBody = zod.object({
  "profile": zod.record(zod.string(), zod.unknown()).describe('UserProfile — AppProfile fields plus a question string')
})

export const AnalyzeCareerDecisionResponse = zod.unknown()
