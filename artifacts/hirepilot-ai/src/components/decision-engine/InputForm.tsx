...
const CAREER_GOALS = [
  "Get a new job in GCC",
  "Relocate to a different GCC country",
  "Negotiate a salary raise",
  "Assess nationalization risk",
  "Evaluate multiple country options",
  "Career pivot to new sector",
  "Understand visa / sponsorship pathway",
  "Plan 5-year GCC career strategy",
];
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-muted-foreground">
                {profile.nationality} · {profile.yearsExperience} yrs ·{" "}
                {profile.sector} · {profile.skills.length} skills ·{" "}
                {profile.targetCountries.length} target countries
              </p>
            </div>
          </div>
          {showProfile ? (
            ...
            >
              <div className="px-5 py-6 space-y-6 border-t border-border/30 bg-background/30">
                ...
                <div>
                  ...
                  <div
                    className={`min-h-[44px] flex flex-wrap gap-2 p-2 border rounded-lg bg-background/60 transition-colors ${errors.skills ? "border-destructive" : "border-border/60"}`}
                  >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          set("currentSalary", Number(e.target.value))
                        }
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          set("targetSalary", Number(e.target.value))
                        }
                        className="field-input pl-12"
                        placeholder="35000"
                      />
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mt-1">
                    {GCC_COUNTRIES.map((c) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`h-4 w-4 rounded border flex items-center justify-center transition-all ${selected ? "bg-primary border-primary" : "border-border"}`}
                          >
                            {selected && (
                              <svg
