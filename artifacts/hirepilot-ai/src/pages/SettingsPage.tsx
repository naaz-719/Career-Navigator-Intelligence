              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-muted/10 border border-border/50 rounded-lg p-2.5 text-sm text-foreground"
                  />
                </div>
                <div>
                  <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      set(
                        "preferredWorkStyle",
                        e.target.value as typeof form.preferredWorkStyle,
                      )
                    }
                    className="w-full bg-muted/30 border border-border/50 rounded-lg p-2.5 text-sm focus:outline-none focus:border-primary/50"
                  >
          ...
          {activeTab === "goals" && (
            <div className="bg-card border border-border/50 rounded-xl p-6">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                These parameters tune the AI's recommendations across the
                platform.
              </p>
                ...
                <div className="pt-4 border-t border-border/50">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <input
                        type="range"
                        className="flex-1 accent-primary mx-4"
                        defaultValue="70"
                      />
