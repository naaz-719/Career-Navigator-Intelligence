...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setProfile((prev) => ({
        ...
        yearsExperience: yearsExperience > 0 ? yearsExperience : prev.yearsExperience,
      }));
  ...
  return (
    <AuthLayout title="Create your account" subtitle="Start your GCC career intelligence journey">
      <form onSubmit={handleSubmit} noValidate className="space-y-4">
        ...
        {/* Role */}
        <div className="space-y-1.5">
          <Label htmlFor="role">Current role / job title <span className="text-muted-foreground font-normal">(optional)</span></Label>
          <Input
            id="role"
            type="text"
